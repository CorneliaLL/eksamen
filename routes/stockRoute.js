...
router.get('/api/stocks/:ticker', stockController.handleGetStockByID); //gets stockdata as json (api)
//router.post('/fetchStock', stockController.fetchStockData); //gets stockdata from AV api and saves in db based on ticker and portfolioID in req.body
